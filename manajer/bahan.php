...
<div class="content-wrapper">
  ...
  <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-building"></i>Bahan</a></li>
      </ol>
  </section>
  <section class="content-header">
    <?php
		 ...
		 <div class="box-body">
		  ...
		  <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#lihat_kegiatan" data-toggle="tab">Lihat Bahan</a></li>
              <li><a href="#tambah_kegiatan" data-toggle="tab">Tambah Bahan</a></li>
            </ul>
              ...
              <div class="tab-pane" id="tambah_kegiatan">
                ...
                <div class="post">
                    <br />
						...
						<!-- /.box-header -->				
						<!-- form start -->
						   <form role="form" action="fungsi.php?proses=tambah_bahan" method="POST" class="form-horizontal" id="tambah">
							<div class="box-body">
							  ...
							  <div class="form-group">
								 ...
								 <div class="col-sm-3">
									 <?php
											...
											$sql=mysql_query("SELECT * FROM bahan_material WHERE id_proyek = '$_GET[id_proyek]' AND kode LIKE 'M0%' order by kode DESC LIMIT 0,1");
							   ...
							   <div class="form-group">
								 <label class="col-sm-2 control-label">Harga Satuan Bahan : </label>
								   <div class="col-sm-3">
						   ...
						   <?php
								...
								{ 
									...
									$kegiatan = mysql_query("SELECT * from bahan_material
															 WHERE bahan_material.id_proyek = '$id_proyek' AND bahan_material.kode LIKE 'M0%'");
									$no=0;
									...
									?>
									 ...
									 <a href='edit_bahan.php?id_proyek=<?=$_GET['id_proyek']?>&id_bahan=<?=$r['id_bahan']?>'class='btn btn-info btn-fill btn-xs' >Ubah</a>
                                    <botton class="btn btn-danger btn-fill btn-wd btn-xs" data-toggle="modal" data-target="#myModal" data-whatever="fungsi.php?proses_hapus=hapus_bahan&id_bahan=<?=$r['id_bahan']?>&id_proyek=<?=$_GET['id_proyek']?>">Hapus</botton>
