				...
				<div class="box box-info">
					<div class="box-header">
						...
						<div class="form-group">
							...
							<form action="?" method="GET">
								<div class="input-group input-group-sm">
									<select name="id_proyek" class="form-control select2" style="width: 100%;">
										...
										?>
										<option <?php if (isset($_GET['id_proyek'])) {
							...
							<br>
							<h5><b>
									<div><i class="fa fa-building text-red"></i> Proyek : <code><?php echo " $r[nama_proyek]" ?></code>
									</div>
									<p>
										<div><i class="fa fa-user text-blue"></i> Pemilik : <?php echo " $r[pemilik]" ?></div>
										<p>
											<div><i class="fa fa-money text-yellow"></i> Biaya : <?php echo "Rp. $biaya" ?></div>
											<p>
												<div><i class="fa fa-map-o text-green"></i> Lokasi : <?php echo " $r[lokasi]" ?></div>
												<p>
								</b></h5>
							<?php
								}
								...
								<div class="tab-pane" id="tambah_kegiatan">
									...
									<div class="post">
										...
										<div class="box-body">
											<h4> Tambah Jadwal</h4>
											<!-- form start -->
											<form role="form" action="fungsi.php?proses_tambah_j=tambah_jadwal" method="POST"
													...
													<div class="form-group">
														...
														<div class="col-sm-2">
															<div class="input-group date">
																...
																<input type="text" class="form-control pull-right" id="tanggal_mulai"
														...
														<div class="col-sm-2">
															<div class="input-group">
																<input type="text" minlength="1" maxlength="3" class="form-control"
																	name="durasi_kegiatan" onkeyup="this.value=this.value.replace(/[^\\0-9\\]/g, '')"
																	required>
									...
									<div class="post">
										...
										";
													...
													<td>
														...
														<?php
																$getjadwal = mysql_query("SELECT id_jadwal FROM jadwal");
																$j = mysql_fetch_array($getjadwal);
																// if ($r['id_jadwal'] == $j['id_jadwal']) { 
																?>
														<a href="edit_jadwal.php?id_proyek=<?= $_GET['id_proyek'] ?>&id_jadwal=<?= $r['id_jadwal'] ?>"
															class="btn btn-info btn-fill btn-sm">Ubah</a>
														<a href='fungsi.php?proses_hapus_jadwal=hapus_jadwal&id_proyek=<?= $_GET['id_proyek'] ?>&id_jadwal=<?= $r['id_jadwal'] ?>'
															class='btn btn-danger btn-fill btn-sm'>Hapus</a>
														<?php
																?>
													</td>
													</tr>
